...
<body>
    <form id="form1" runat="server">
        ...
        <div style="text-align: center">
            ...
            <asp:TextBox ID="txtValidate" runat="server" Height="23px" Width="106px"></asp:TextBox>
            <asp:Image ID="imgValidate" runat="server" Height="22px" Width="58px" ImageUrl="~/ValidateNum.aspx" EnableTheming="True" />
            <asp:Button ID="btnValidate" runat="server" OnClick="btnValidate_Click" Text="验证" />
            </BR>
